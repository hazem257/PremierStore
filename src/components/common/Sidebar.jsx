import { BarChart2, DollarSign, Menu,SquareChartGantt , Settings, ShoppingBag, ShoppingCart, TrendingUp, Users } from "lucide-react";
...
const SIDEBAR_ITEMS = [
  ...
  { name: "الموردين", icon: SquareChartGantt , color: "#8B5CF6", href: "/suppliers" },
	...
	{ name: "المبيعات", icon: DollarSign, color: "#10B981", href: "/sales" },
